...
#define YOUR_GAME_XBE_PATH      "..\\..\\..\\..\\games\\Jet Set Radio Future\\default.xbe"
#define YOUR_GAME_DIR            "..\\..\\..\\..\\games\\Jet Set Radio Future"
                   ...
                   LPSTR lpCmdLine, int nCmdShow)
{
    ...
    /* Step 1: Find and load the XBE */
    {
        ...
        if (!find_game(tried, sizeof tried)) {
            ...
            MessageBoxA(NULL, message, "Jet Set Radio Future", MB_ICONERROR);
            return 1;
        }
        printf("Game files: %s\n", g_game_dir);
