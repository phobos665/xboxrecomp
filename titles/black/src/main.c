/**
 * Black - Recompiled Game Entry Point
 *
...
#define YOUR_GAME_XBE_PATH      "..\\..\\..\\..\\games\\Black\\default.xbe"
#define YOUR_GAME_DIR            "..\\..\\..\\..\\games\\Black"
                   ...
                   LPSTR lpCmdLine, int nCmdShow)
{
    ...
    /* Step 1: Find and load the XBE */
    {
        ...
        if (!find_game(tried, sizeof tried)) {
            ...
            MessageBoxA(NULL, message, "Black", MB_ICONERROR);
            return 1;
        }
        printf("Game files: %s\n", g_game_dir);
