/**
 * Gauntlet Dark Legacy - Recompiled Game Entry Point
 *
 ...
 */
#define YOUR_GAME_ENTRY_POINT   0x000B389B  /* XBE entry point VA */
...
#define YOUR_GAME_XBE_PATH      "..\\..\\..\\..\\games\\Gauntlet Dark Legacy\\default.xbe"
#define YOUR_GAME_DIR            "..\\..\\..\\..\\games\\Gauntlet Dark Legacy"
                   ...
                   LPSTR lpCmdLine, int nCmdShow)
{
    ...
    printf("=== Gauntlet Dark Legacy - Static Recompilation ===\n");
    printf("Loading XBE...\n");
    ...
    /* Step 1: Find and load the XBE */
    {
        ...
        if (!find_game(tried, sizeof tried)) {
            ...
            MessageBoxA(NULL, message, "Gauntlet Dark Legacy", MB_ICONERROR);
            return 1;
        }
        printf("Game files: %s\n", g_game_dir);
