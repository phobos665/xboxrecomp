/**
 * MechAssault - Recompiled Game Entry Point
 *
 ...
 */
#define YOUR_GAME_ENTRY_POINT   0x00017999  /* XBE entry point VA */
...
#define YOUR_GAME_XBE_PATH      "..\\..\\..\\..\\games\\MechAssault\\default.xbe"
#define YOUR_GAME_DIR            "..\\..\\..\\..\\games\\MechAssault"
                   ...
                   LPSTR lpCmdLine, int nCmdShow)
{
    ...
    printf("=== MechAssault - Static Recompilation ===\n");
    printf("Loading XBE...\n");
    ...
    /* Step 1: Find and load the XBE */
    {
        ...
        if (!find_game(tried, sizeof tried)) {
            ...
            MessageBoxA(NULL, message, "MechAssault", MB_ICONERROR);
            return 1;
        }
        printf("Game files: %s\n", g_game_dir);
