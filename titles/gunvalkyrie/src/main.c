/**
 * Gunvalkrye - Recompiled Game Entry Point
 *
 ...
 */
#define YOUR_GAME_ENTRY_POINT   0x0013BF0A  /* XBE entry point VA */
...
#define YOUR_GAME_XBE_PATH      "..\\..\\..\\..\\games\\Gunvalkrye\\default.xbe"
#define YOUR_GAME_DIR            "..\\..\\..\\..\\games\\Gunvalkrye"
                   ...
                   LPSTR lpCmdLine, int nCmdShow)
{
    ...
    printf("=== Gunvalkrye - Static Recompilation ===\n");
    printf("Loading XBE...\n");
    ...
    /* Step 1: Find and load the XBE */
    {
        ...
        if (!find_game(tried, sizeof tried)) {
            ...
            MessageBoxA(NULL, message, "Gunvalkrye", MB_ICONERROR);
            return 1;
        }
        printf("Game files: %s\n", g_game_dir);
