/**
 * Dino Crisis 3 - Recompiled Game Entry Point
 *
 ...
 */
#define YOUR_GAME_ENTRY_POINT   0x001A9AD1  /* XBE entry point VA */
...
#define YOUR_GAME_XBE_PATH      "..\\..\\..\\..\\games\\Dino Crisis 3\\default.xbe"
#define YOUR_GAME_DIR            "..\\..\\..\\..\\games\\Dino Crisis 3"
                   ...
                   LPSTR lpCmdLine, int nCmdShow)
{
    ...
    printf("=== Dino Crisis 3 - Static Recompilation ===\n");
    printf("Loading XBE...\n");
    ...
    /* Step 1: Find and load the XBE */
    {
        ...
        if (!find_game(tried, sizeof tried)) {
            ...
            MessageBoxA(NULL, message, "Dino Crisis 3", MB_ICONERROR);
            return 1;
        }
        printf("Game files: %s\n", g_game_dir);
