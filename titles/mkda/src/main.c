/**
 * Mortal Kombat: Deadly Alliance - Recompiled Game Entry Point
 *
 ...
 */
#define YOUR_GAME_ENTRY_POINT   0x0015ADAC  /* XBE entry point VA */
...
#define YOUR_GAME_XBE_PATH      "..\\..\\..\\..\\games\\Mortal Kombat Deadly Alliance\\default.xbe"
#define YOUR_GAME_DIR            "..\\..\\..\\..\\games\\Mortal Kombat Deadly Alliance"
                   ...
                   LPSTR lpCmdLine, int nCmdShow)
{
    ...
    printf("=== Mortal Kombat: Deadly Alliance - Static Recompilation ===\n");
    printf("Loading XBE...\n");
    ...
    /* Step 1: Find and load the XBE */
    {
        ...
        if (!find_game(tried, sizeof tried)) {
            ...
            MessageBoxA(NULL, message, "Mortal Kombat: Deadly Alliance", MB_ICONERROR);
            return 1;
        }
        printf("Game files: %s\n", g_game_dir);
