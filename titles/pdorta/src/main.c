/**
 * Panzer Dragoon Orta - Recompiled Game Entry Point
 *
 ...
 */
#define YOUR_GAME_ENTRY_POINT   0x00231E6C  /* XBE entry point VA */
...
#define YOUR_GAME_XBE_PATH      "..\\..\\..\\..\\games\\Panzer Dragoon Orta\\default.xbe"
#define YOUR_GAME_DIR            "..\\..\\..\\..\\games\\Panzer Dragoon Orta"
                   ...
                   LPSTR lpCmdLine, int nCmdShow)
{
    ...
    printf("=== Panzer Dragoon Orta - Static Recompilation ===\n");
    printf("Loading XBE...\n");
    ...
    /* Step 1: Find and load the XBE */
    {
        ...
        if (!find_game(tried, sizeof tried)) {
            ...
            MessageBoxA(NULL, message, "Panzer Dragoon Orta", MB_ICONERROR);
            return 1;
        }
        printf("Game files: %s\n", g_game_dir);
