/**
 * Tony Hawk's Pro Skater 2X - Recompiled Game Entry Point
 *
 ...
 */
#define YOUR_GAME_ENTRY_POINT   0x001B9FD3  /* XBE entry point VA */
...
#define YOUR_GAME_XBE_PATH      "..\\..\\..\\..\\games\\Tony Hawk's Pro Skater 2X\\default.xbe"
#define YOUR_GAME_DIR            "..\\..\\..\\..\\games\\Tony Hawk's Pro Skater 2X"
                   ...
                   LPSTR lpCmdLine, int nCmdShow)
{
    ...
    printf("=== Tony Hawk's Pro Skater 2X - Static Recompilation ===\n");
    printf("Loading XBE...\n");
    ...
    /* Step 1: Find and load the XBE */
    {
        ...
        if (!find_game(tried, sizeof tried)) {
            ...
            MessageBoxA(NULL, message, "Tony Hawk's Pro Skater 2X", MB_ICONERROR);
            return 1;
        }
        printf("Game files: %s\n", g_game_dir);
